...
- **2026-04-07 — Documentation improvement plan merged to decisions**. Comprehensive 13-item improvement plan reviewed and merged into `.squad/decisions.md` as formal decision (status: Implemented). Trinity executed top 8 items (getting-started tutorial, troubleshooting FAQ, worked-example rewrite, inconsistency fixes, README updates). Outcome: 28 files changed, 1,337 lines added. Decisions now tracks what was proposed, what was implemented, and rationale.
