...
|-----------|----------|----------|
| Architecture, design, project structure | Neo 🏗️ | .NET project layout, dependency selection, Python→.NET mapping |
| Core pipeline, graph algorithms, CLI, export | Trinity 🔧 | Detect, extract, build, cluster, analyze, report, export modules |
| AI/LLM integration, Copilot SDK, prompts | Morpheus 🔧 | Microsoft.Extensions.AI, IChatClient, semantic extraction |
| Code review | Neo 🏗️ | Review PRs, check quality, ensure .NET idioms |
